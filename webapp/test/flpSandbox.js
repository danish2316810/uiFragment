		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "first time ",
									"targetURL": "#danui5standui5project-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"danui5standui5project-display": {
								"semanticObject": "danui5standui5project",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=danui5stand.ui5project",
									"url": sap.ui.require.toUrl("danui5stand/ui5project")
								}
							}
						}
					}
